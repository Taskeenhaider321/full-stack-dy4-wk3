        ...
        <>
            ...
            <div className="task-container" >
                {loading ? <h2>
                    ...
                    taskList && taskList.map((obj, index) => <Card key={index + "card-task-main"} stateManage={stateManage} setStateManage={setStateManage} taskObj={obj} index={index} deleteTask={deleteTask} updateListArray={updateListArray} />)}
            </div>
